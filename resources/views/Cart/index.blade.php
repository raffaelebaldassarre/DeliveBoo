                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <div v-for="(item, index) in orderCart">
                            <div class="d-flex justify-content-center align-items-center my-1">
                                <button id="minus" class="btn btn-outline" @click="minusDish(item)"><i
                                        class="fas fa-minus"></i></button>
                                <div id="food-check">@{{ item.quantity }}x @{{ item.name }} &rArr;
                                    @{{ item.totalDishPrice }} €</div>
                                <button id="plus" class="btn btn-outline" @click="moreDish(item)"><i
                                        class="fas fa-plus"></i></button>
                            </div>
                            <div class="d-flex justify-content-center my-2">
                                <button id="trash" class="btn btn-outline" @click="deleteDish(index)"
                                    class="btn-danger delete"><i class="fas fa-trash-alt"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="receipt_container text-center bg-white">
            ...
            <form action="{{ route('cart.store') }}" method="post" id="payment-order-user" name="payment-order-user"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="special_requests" id="special_requests"
                ...
                <div id="dropin-wrapper">
                    ...
                    <button id="submit-button" class="btn btn-lg btn-outline font-weight-bold p-4">Procedi al
                        pagamento</button>
                </div>
