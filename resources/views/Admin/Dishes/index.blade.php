...
@section('content')
        ...
        <table class="table" id="dishes-table-adm-large">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nome</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="height: 150px; width: auto;"><img src="{{asset('storage/' . $dish->cover)}}" alt="" style="height: 100%"></td>
        ...
        <table class="table" id="dishes-table-adm-short">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nome</th>
