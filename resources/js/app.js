    ...
    methods: {
        matchRestaurant() {
            this.restaurantId = parseInt(
                document.getElementById("rest_id").textContent
            );
        ...
        takeOrder(dish) {
            if (this.orderCart.some(obj => obj.id === dish.id)) {
                ...
                Vue.set(
                    this.orderCart[this.orderCart.length - 1],
                    "quantity",
                    0
                );
                this.moreDish(dish);
        ...
        totalDishPrice() {
            ...
            this.orderCart[this.orderCart.length - 1].totalDishPrice +=
                this.orderCart[this.orderCart.length - 1].price *
                this.orderCart[this.orderCart.length - 1].quantity;
        },
